...
export class ValuesService {
    ...
    constructor (indexConnector: IndexConnector, valuesConnector: ValuesConnector) {
   ...
   async getValues(): Promise<IServicePayload> {
    ...
    if (indexResponse) {
      result.missionStatement = indexResponse.data.missionStatement.replace('/swagger/index.html', 'https://localhost:5001/swagger/index.html');
    }
