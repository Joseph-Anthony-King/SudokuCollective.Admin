...
export default function () {
  const emailRules = (
    ...
    return [
      (v: string) =>
        !!v || RulesMessages.requiredMessage.replace("{{value}}", "Email"),
      (v: string) =>
        /^\w+([.-]?\w+)*@\w+([.-]?\w+)*(\.\w{2,3})+$/.test(v) ||
        RulesMessages.emailInvalidMessage,
  ...
  const passwordRules = (
    ...
    return [
      (v: string) =>
        !!v || RulesMessages.requiredMessage.replace("{{value}}", "Password"),
      (v: string) =>
        /^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[!@#$%^&*+=?\-_.,]).{3,21}$/.test(
          v
        ) || RulesMessages.passwordRegexMessage,
      (v: string) =>
        !invalidPasswords.includes(v) || RulesMessages.passwordInvalidMessage,
    ];
  };
  const confirmPasswordRules = (
    ...
    return [
      (v: string) =>
        !!v ||
        RulesMessages.requiredMessage.replace("{{value}}", "Confirm Password"),
      (v: string) =>
        /^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[!@#$%^&*+=?\-_.,]).{3,21}$/.test(
          v
        ) || RulesMessages.passwordRegexMessage,
  ...
  const userNameRules = (
    ...
    return [
      (v: string) =>
        !!v || RulesMessages.requiredMessage.replace("{{value}}", "User Name"),
      (v: string) =>
        /^[a-zA-Z0-9!@#$%^&*+=<>?-_.,].{3,}$/.test(v) ||
        RulesMessages.userNameRegexMessage,
